...
function Welcome() {
    ...
    return(
		<div>
            ...
            <img src={process.env.PUBLIC_URL + '/images/DumbGram.png'} alt="DumbGram" />
            ...
            <div className="lp-tombol">
                <div>
                    <p>
                        <button className="login-auth-button" onClick={handleClickLogin}>Login</button> <button className="register-auth-button" onClick={handleClickRegister}>Register</button>
                    </p>
